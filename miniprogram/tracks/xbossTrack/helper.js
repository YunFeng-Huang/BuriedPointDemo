...
export const getBoundingClientRect = function (element) {
    return new Promise((reslove) => {
        const query = (typeof my == 'undefined'?wx:my).createSelectorQuery();
...
export const isClickTrackArea = function (clickInfo, boundingClientRect, scrollOffset) {
    ...
    const x = clickInfo.detail.x || clickInfo.detail.pageX; // 点击的x y坐标
    const y = clickInfo.detail.y || clickInfo.detail.pageY; // 点击的x y坐标
